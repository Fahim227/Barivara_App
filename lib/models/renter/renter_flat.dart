...
List<RenterFlat> renterFlatFromJson(String str) => List<RenterFlat>.from(json.decode(str).map((x) => RenterFlat.fromJson(x)));

String renterFlatToJson(List<RenterFlat> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RenterFlat {
  ...
  factory RenterFlat.fromJson(Map<String, dynamic> json) => RenterFlat(
    flatId: json["flat_id"],
